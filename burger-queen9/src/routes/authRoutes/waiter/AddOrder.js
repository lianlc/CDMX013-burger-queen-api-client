...
<main className="mainOrderWaiter">
            ...
            <section className="orderitems">
                ...
                <div className="description"><p>:x::nota:</p><p>cantidad</p><p>description</p><p>total</p></div>
                <div className="description"><p>:x::nota:</p><p>cantidad</p><p>description</p><p>total</p></div>
                <div className="description"><p> :papelera: :lápiz2:</p><p>cantidad</p><p>description</p><p>total</p></div>
                <div className="description"><p> :papelera: :lápiz2:</p><p>cantidad</p><p>description</p><p>total</p></div>
                <div className="totalOrder"><h4>TOTAL:</h4><h4>:flecha_a_la_derecha:$500</h4></div>
            </section>
</main>
